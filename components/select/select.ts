...
@Component({
  ...
  <div tabindex="0"
    ...
    <div class="ui-select-match"
         *ngIf="!inputMode">
      <span tabindex="-1" [ngClass]="onRequired()"
...
export class SelectComponent implements OnInit {
  ...
  public set items(value: Array<any>) {
    if (!value) {
      ...
      this.itemObjects = this._items.map((item: any) => new SelectItem({ id: item[this.idField], text: item[this.textField] }));
      this.refreshOptions();
    }
  }
